...
class Transaction(models.Model):
    ...
    recurringEnd = models.CharField(max_length=120, blank = True)
    recurringPeriod = models.CharField(max_length=120, blank = True)
    recurringGap = models.IntegerField(blank = True)
